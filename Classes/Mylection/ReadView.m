...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
		...
		backGroundImgView = [[UIImageView alloc]initWithFrame: CGRectMake(0, 0, 320,  DEVICE_HEIGHT-44-49-20)];
		...
		m_textView = [[UITextView alloc]initWithFrame: CGRectMake(0, 0, 320,  DEVICE_HEIGHT-44-49-20)];
